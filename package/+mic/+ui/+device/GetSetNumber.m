...
% See also HARDWAREO, AXIS
    ...
    methods (Access = protected)
        ...
        % See also HARDWAREIO, INIT, BUILD
            ...
            this.uibIndex = mic.ui.common.Button( ...
                'cText', 'Index', ...
                'lImg', true, ...
                'u8Img', imread(fullfile(mic.Utils.pathAssets(), 'mcindex.png')), ...
                'lAsk', true, ...
                'cMsg', 'Are you sure you want to index?' ...
                );
        ...
        %@return {ApivHardwareIO}
            api = mic.device.GetSetNumber(this.cName, 0, this.clock);
        end
