...
%                 ...%'BorderType', 'none', ...
%                 'Position', MicUtils.lt2lb([dLeft, dTop, ...
...
%             );
            ...
            this.hCameraControlPanel = uipanel(...
                ...
                'Clipping', 'on',...
                'BackgroundColor', this.bgcolor, ...
                'Position', MicUtils.lt2lb([10, dTop, ...
                                        CCPHeight, 250], this.hFigure) ...
            );
            
           
            
            this.uieCCDResX.build(this.hCameraControlPanel, dLeftCol1, dTop, dEditWidth, MicUtils.dEDITHEIGHT);
            this.uieCCDResY.build(this.hCameraControlPanel, dLeftCol2, dTop, dEditWidth, MicUtils.dEDITHEIGHT);
            this.uieCCDBinning.build(this.hCameraControlPanel, dLeftCol3, dTop, dEditWidth, MicUtils.dEDITHEIGHT);
            dTop = dTop + dSep;
            
            
            this.uibStream.build(this.hCameraControlPanel, dLeftCol1, dTop, 120, MicUtils.dEDITHEIGHT * 1.25);
            this.uibStop.build(this.hCameraControlPanel, dLeftCol1 + 130 , dTop, 120, MicUtils.dEDITHEIGHT * 1.25);
            dTop = dTop + dSep - 10;
            this.uibCapture.build(this.hCameraControlPanel, dLeftCol1, dTop, 250, MicUtils.dEDITHEIGHT * 1.5);
            dTop = dTop + dSep;
        ...
        function buildAxes(this)
             this.hCameraAxes = axes(...
                    'Parent', this.hFigure,...
                    'Units', 'pixels',...
                    'Position',MicUtils.lt2lb([350 25 512 512], this.hFigure),...
                    'XColor', [0 0 0],...
                    'YColor', [0 0 0],...
