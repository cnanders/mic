classdef HardwareIOWithSave < HardwareIO
    ...
    methods
        ...
        function build(this, hParent, dLeft, dTop)
            ...
            % Update width
            dWidth = 410;
            set(this.hPanel, 'Position', MicUtils.lt2lb([dLeft dTop dWidth 36], hParent));
    ...
    methods (Access = protected)
        ...
        function init(this)
            ...
            this.uibSave = UIButton( ...
                'Save', ...
                true, ...
                imread(fullfile(MicUtils.pathAssets(), 'axis-save.png')) ...
                );
            
            this.uibDelete = UIButton( ...
                'Delete', ...
                true, ...
                imread(fullfile(MicUtils.pathAssets(), 'axis-delete.png')) ...
                );
