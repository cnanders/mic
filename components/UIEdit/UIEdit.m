...
% Antoine Wojdyla, April 3rd, 2013    
    ...
    methods
        ...
        %% constructor
        function this= UIEdit(cLabel, cType, lShowLabel, cHorizontalAlignment)
        ...
        % @param {mixed 1x1} the maximum value
            ...
            % 2013.05.21 CNA
            % Does not make sense to have xMin and xMax on UIEdits of type
