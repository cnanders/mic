    ...
    methods
        ...
        % See also INIT, DELETE
            ...
            this.hUI = uipanel( 'Parent', this.hParent,...%'Title', this.cName,...
                ...
                'Clipping', 'on',...
                'Units', 'pixels',...
                'Position', MicUtils.lt2lb([dTop dLeft Scan.dWidth Scan.dHeight], this.hParent));
            drawnow;
            ...
            uicontrol('Parent', this.hUI,...
                ...
                'String',sprintf('Scan\n%s',this.cName),...
                'Units','pixels',...
                'Position',MicUtils.lt2lb([0 posy 56 36],this.hUI),...
            ...
            this.uib_run = uicontrol('Parent', this.hUI,...
                ...
                'CData', this.img_Scan,...
                'Units','pixels',...
                'Position',MicUtils.lt2lb([posx+3*dWidth_box posy 36 36],this.hUI),...
                'Callback',@this.handleUI);
            ...
            this.uib_stop = uicontrol('Parent', this.hUI,...
                ...
                'CData', this.img_Stop,...
                'Units','pixels',...
                'Position',MicUtils.lt2lb([posx+3*dWidth_box+36 posy 36 36],this.hUI),...
                'Callback',@this.handleUI);
            ...
            this.uib_save = uicontrol('Parent', this.hUI,...
                ...
                'CData', this.img_Save,...
                'Units','pixels',...
                'Position',MicUtils.lt2lb([posx+3*dWidth_box+36+36 posy 36 36],this.hUI),...
                'Callback',@this.handleUI);
