...
% See also HARDWAREO, AXIS
    ...
    methods        
        ...
        % See also HARDWAREIO, INIT, DELETE       
            ...
            this.hImage = image(imread(fullfile(MicUtils.pathAssets(), 'HardwareIO.png')));
...
%             
            ...
            this.u8Play     = imread(fullfile(MicUtils.pathAssets(), 'axis-play.png'));
            this.u8Pause    = imread(fullfile(MicUtils.pathAssets(), 'axis-pause.png'));
            this.u8Plus     = imread(fullfile(MicUtils.pathAssets(), 'axis-plus.png'));
            this.u8Minus    = imread(fullfile(MicUtils.pathAssets(), 'axis-minus.png'));
            ...
            this.uitCal = UIToggle( ...
                ...
                'cal', ...  % (on) showing cal
                true, ...
                imread(fullfile(MicUtils.pathAssets(), 'mcRAW.png')), ...
                imread(fullfile(MicUtils.pathAssets(), 'mcCAL.png')) ...
                );
            ...
            this.uibSetup = UIButton( ...
                'Setup', ...
                true, ...
                imread(fullfile(MicUtils.pathAssets(), 'mcsetup.png')) ...
                );
