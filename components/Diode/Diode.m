...
%% Constructor
        ...
        %   Diode.build(hParent, dLeft, dTop)
            ...
            this.hImage = image(imread(fullfile(Utils.pathAssets(), 'HardwareO.png')));
            set(this.hImage, 'Parent', this.hAxes);
            % set(this.hImage, 'CData', imread(fullfile(Utils.pathAssets(), 'HardwareO.png')));
    ...
    methods (Access = private)
        ...
        function init(this)
            ...
            this.uitActive = UIToggle( ...
                ...
                'disable', ...  % (on) active
                true, ...
                imread(fullfile(Utils.pathAssets(), 'controllernotactive.png')), ...
                imread(fullfile(Utils.pathAssets(), 'controlleractive.png')), ...
                st1, ...
                st2);
            %}
            ...
            this.uibSetup = UIButton( ...
                'Setup', ...
                true, ...
                imread(fullfile(Utils.pathAssets(), 'settings-24.png')) ...
                );
